...
public class SubscribersOnMyApp {
    ...
    SubscribersOnMyAppV2Listener getListSubscriberListenerV2;
    ...
    private void getSubscribersOfChannel(Context context, String key, String id)
    {
        ...
        getListSubscriberListenerV2 = (SubscribersOnMyAppV2Listener) context;
