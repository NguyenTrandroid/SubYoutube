...
public class DataChannelOnCampaign {
    ...
    SubscriberOnCampaignListener subscriberOnCampaignListener;
    ...
    private void getSubscribersOfChannel(Context context, String key, String id)
    {
        ...
        subscriberOnCampaignListener = (SubscriberOnCampaignListener) context;
    ...
    private void responseGetSubcribersOfChannel(SubChannelItem itemSub) {
        ...
        {
            subscriberOnCampaignListener.onCompletedListSubcriberCampaign(listSubChannelItem);
        }
    }
